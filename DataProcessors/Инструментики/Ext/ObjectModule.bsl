...
//
// Параметры:
//  ТекстXML - Строка - XML-текст универсального пакета
//  ОжидаемыйТип - Строка - Какой тип объекта необходим.
//                 При попытке чтения универсального пакета с другим типом объекта вызывается исключение
//
// Возвращаемое значение:
//  Структура:
//  При корректном разборе:
//  * ВерсияФормата - Число - Версия формата открытого файла
//  * Объект - ОбъектXDTO - Прочитанный объект
...
//
// Параметры:
//  ВерсияФормата - Число - Используемая версия формата XDTO
...
//
// Параметры:
//  ИмяИнструмента - Строка - Имя инструмента, которому принадлежит настройка
...
//
// Параметры:
//  ПолнаяВерсия - Строка - Версия вида "8.3.22" / "8.3.22.2208" / "8_3_22"
// 
// Возвращаемое значение:
//  Число
...
Функция ВключенаЗащитаОтОпасныхДействий()
	...
	Возврат (ЗначениеЗаполнено(ПользовательИБ.Имя) И ПредупреждатьОбОпасныхДействиях);
КонецФункции
