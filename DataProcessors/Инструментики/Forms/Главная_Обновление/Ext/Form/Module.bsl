...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЕстьОбновлениеТестовой Тогда
		Если СравнитьВерсии(ПоследняяСтабильная, ПоследняяТестовая) = -1 Тогда
...
Процедура ОбработкаНавигационнойСсылки(НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	Иначе
		ВызватьИсключение "Недопустимая навигационная ссылка";
	КонецЕсли;
КонецПроцедуры
...
Асинх Процедура СкачатьВерсиюАсинх(Вариант, Ссылка)
	...
	Текст = НСтр("ru='Скачивание завершено. Закройте все окна Инструментиков и откройте только что скачанную обработку'");
