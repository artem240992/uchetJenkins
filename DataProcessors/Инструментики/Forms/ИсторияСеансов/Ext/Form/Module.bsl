...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИнформацияВыключена = (ИспользованиеЖурналаРегистрации.Найти(УровеньЖурналаРегистрации.Информация) = Неопределено);
	Элементы.ДекорацияРегистрацияИнформацииВыключена.Видимость = ИнформацияВыключена;
КонецПроцедуры
...
&НаСервере
Процедура СортироватьТаблицуЗначений(Знач ИмяТаблицыФормы, Знач Направление)
