...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, ПараметрыСоединенияСКластером, "МетодПодключения, АдресАгента,
		|ПортАгента, ЛогинАгента, ПарольАгента,
...
Процедура УдалитьСохраненныеПараметрыНаСервере()
	...
	МодульОбъекта.СохранитьНастройку("АдминистрированиеСервера", "ПараметрыСоединенияСКластером", Неопределено);
КонецПроцедуры
