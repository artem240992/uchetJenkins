...
// BSLLS:AllFunctionPathMustHaveReturn-off (это асинхронная функция)
...
Асинх Функция ВызватьВосстановлениеНастроекАутентификацииПользователяАсинх()
	...
	Текст = НСтр("ru = 'Пароль пользователя был заменен на временный для возможности аутентификации без пароля
